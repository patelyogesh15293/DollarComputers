...
namespace DollarComputers.comp1004namesDataSetTableAdapters {
...
SELECT productID, cost, manufacturer, model, RAM_type, RAM_size, displaytype, screensize, resolution, CPU_Class, CPU_brand, CPU_type, CPU_speed, CPU_number, condition, OS, platform, HDD_size, HDD_speed, GPU_Type, optical_drive, Audio_type, LAN, WIFI, width, height, depth, weight, moust_type, power, webcam FROM products WHERE (productID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DollarComputers.Properties.Settings.Default.comp1004namesConnectionString;
        }
        ...
        public virtual int Fill(comp1004namesDataSet.productsDataTable dataTable) {
        ...
        public virtual comp1004namesDataSet.productsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            comp1004namesDataSet.productsDataTable dataTable = new comp1004namesDataSet.productsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(comp1004namesDataSet.productsDataTable dataTable) {
